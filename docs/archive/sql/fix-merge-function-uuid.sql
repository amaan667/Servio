-- Fix the merge function to properly handle UUID to TEXT conversion
...
-- Create a single, properly typed function that accepts TEXT parameters and converts them to UUID
