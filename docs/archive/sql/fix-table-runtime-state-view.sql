-- Fix the table_runtime_state view that's causing integer conversion errors

-- 1. First, let's see the current view definition
SELECT 'Current table_runtime_state view definition:' as info;
SELECT 
    view_definition
...
-- 3. Create a corrected view that handles string labels properly
