/**
 * Auto-generated test for dashboard/orders/one
 * Generated: 2025-11-23T00:14:32.209Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { GET as getGET } from "@/app/api/dashboard/orders/one/route";
...
describe("Dashboard Orders One API", () => {
  describe("GET dashboard/orders/one", () => {
    it("should handle get request", async () => {
      const request = createMockRequest("GET", "http://localhost:3000/api//dashboard/orders/one");
