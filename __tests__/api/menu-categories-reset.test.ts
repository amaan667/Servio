/**
 * Auto-generated test for menu/categories/reset
 * Generated: 2025-11-23T00:14:32.212Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { POST as postPOST } from "@/app/api/menu/categories/reset/route";
...
describe("Menu Categories Reset API", () => {
  describe("POST menu/categories/reset", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/api//menu/categories/reset");
