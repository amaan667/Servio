/**
 * Auto-generated test for catalog/replace
 * Generated: 2025-11-23T00:14:32.207Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { POST as postPOST } from "@/app/api/catalog/replace/route";
...
describe("Catalog Replace API", () => {
  describe("POST catalog/replace", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/api//catalog/replace");
