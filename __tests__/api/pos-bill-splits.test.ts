...
import { GET as getGET } from "@/app/apipos/bill-splits/route";
import { POST as postPOST } from "@/app/apipos/bill-splits/route";
...
describe("Pos Bill Splits API", () => {
  describe("GET pos/bill-splits", () => {
    it("should handle get request", async () => {
      const request = createMockRequest("GET", "http://localhost:3000/apipos/bill-splits");
  ...
  describe("POST pos/bill-splits", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/apipos/bill-splits");
      // TODO: Import and test actual route handler
