...
/**
 * Auto-generated test for orders/verify
 * Generated: 2025-11-23T00:14:32.215Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { GET as getGET } from "@/app/api/orders/verify/route";
...
describe("Orders Verify API", () => {
  describe("GET orders/verify", () => {
    it("should handle get request", async () => {
      const request = createMockRequest("GET", "http://localhost:3000/api//orders/verify");
