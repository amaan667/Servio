...
import { POST as postPOST } from "@/app/apitable-management/seat-party/route";
...
describe("Table Management Seat Party API", () => {
  describe("POST table-management/seat-party", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/apitable-management/seat-party");
