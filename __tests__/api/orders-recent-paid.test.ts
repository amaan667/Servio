/**
 * Auto-generated test for orders/recent-paid
 * Generated: 2025-11-23T00:14:32.214Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { GET as getGET } from "@/app/api/orders/recent-paid/route";
...
describe("Orders Recent Paid API", () => {
  describe("GET orders/recent-paid", () => {
    it("should handle get request", async () => {
      const request = createMockRequest("GET", "http://localhost:3000/api//orders/recent-paid");
