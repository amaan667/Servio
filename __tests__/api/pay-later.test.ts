...
/**
 * Auto-generated test for pay/later
 * Generated: 2025-11-23T00:14:32.215Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { POST as postPOST } from "@/app/api/pay/later/route";
...
describe("Pay Later API", () => {
  describe("POST pay/later", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/api//pay/later");
