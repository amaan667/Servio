...
import { POST as postPOST } from "@/app/apisignup/with-subscription/route";
...
describe("Signup With Subscription API", () => {
  describe("POST signup/with-subscription", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/apisignup/with-subscription");
