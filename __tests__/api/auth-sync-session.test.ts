/**
 * Auto-generated test for auth/sync-session
 * Generated: 2025-11-23T00:14:32.207Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { POST as postPOST } from "@/app/api/auth/sync-session/route";
...
describe("Auth Sync Session API", () => {
  describe("POST auth/sync-session", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/api//auth/sync-session");
