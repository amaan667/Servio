...
/**
 * Auto-generated test for inventory/stock/adjust
 * Generated: 2025-11-23T00:14:32.211Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { POST as postPOST } from "@/app/api/inventory/stock/adjust/route";
...
describe("Inventory Stock Adjust API", () => {
  describe("POST inventory/stock/adjust", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/api//inventory/stock/adjust");
