...
/**
 * Auto-generated test for tables-runtime
 * Generated: 2025-11-23T00:14:32.222Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { GET as getGET } from "@/app/api/tables-runtime/route";
...
describe("Tables Runtime API", () => {
  describe("GET tables-runtime", () => {
    it("should handle get request", async () => {
      const request = createMockRequest("GET", "http://localhost:3000/apitables-runtime");
