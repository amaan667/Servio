/**
 * Auto-generated test for feedback-responses
 * Generated: 2025-11-23T00:14:32.210Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { POST as postPOST } from "@/app/api/feedback-responses/route";
...
describe("Feedback Responses API", () => {
  describe("POST feedback-responses", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/apifeedback-responses");
