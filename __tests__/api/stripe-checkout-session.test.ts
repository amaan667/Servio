/**
 * Auto-generated test for stripe/checkout-session
 * Generated: 2025-11-23T00:14:32.219Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { GET as getGET } from "@/app/api/stripe/checkout-session/route";
...
describe("Stripe Checkout Session API", () => {
  describe("GET stripe/checkout-session", () => {
    it("should handle get request", async () => {
      const request = createMockRequest("GET", "http://localhost:3000/api//stripe/checkout-session");
