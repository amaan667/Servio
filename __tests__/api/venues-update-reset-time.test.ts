/**
 * Auto-generated test for venues/update-reset-time
 * Generated: 2025-11-23T00:14:32.223Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { POST as postPOST } from "@/app/api/venues/update-reset-time/route";
...
describe("Venues Update Reset Time API", () => {
  describe("POST venues/update-reset-time", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/api//venues/update-reset-time");
