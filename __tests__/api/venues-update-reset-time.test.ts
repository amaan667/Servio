...
import { POST as postPOST } from "@/app/apivenues/update-reset-time/route";
...
describe("Venues Update Reset Time API", () => {
  describe("POST venues/update-reset-time", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/apivenues/update-reset-time");
