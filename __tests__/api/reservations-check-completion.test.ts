/**
 * Auto-generated test for reservations/check-completion
 * Generated: 2025-11-23T00:14:32.217Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest, parseJsonResponse } from "../helpers/api-test-helpers";
import { POST as postPOST } from "@/app/api/reservations/check-completion/route";
...
describe("Reservations Check Completion API", () => {
  describe("POST reservations/check-completion", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/api/reservations/check-completion");
