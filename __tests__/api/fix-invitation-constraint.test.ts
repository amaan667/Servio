/**
 * Auto-generated test for fix-invitation-constraint
 * Generated: 2025-11-23T00:14:32.210Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { POST as postPOST } from "@/app/api/fix-invitation-constraint/route";
...
describe("Fix Invitation Constraint API", () => {
  describe("POST fix-invitation-constraint", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/apifix-invitation-constraint");
