/**
 * Auto-generated test for staff/check
 * Generated: 2025-11-23T00:14:32.218Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { GET as getGET } from "@/app/api/staff/check/route";
...
describe("Staff Check API", () => {
  describe("GET staff/check", () => {
    it("should handle get request", async () => {
      const request = createMockRequest("GET", "http://localhost:3000/api//staff/check");
