...
import { PATCH as patchPATCH } from "@/app/api/orders/[orderId]/update-payment-mode/route";
...
describe("Orders OrderId Update Payment Mode API", () => {
  describe("PATCH orders/[orderId]/update-payment-mode", () => {
    it("should handle patch request", async () => {
      const request = createMockRequest("PATCH", "http://localhost:3000/apiorders/[orderId]/update-payment-mode");
