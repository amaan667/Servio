...
import { GET as getGET } from "@/app/apikds/stations/route";
import { POST as postPOST } from "@/app/apikds/stations/route";
...
describe("Kds Stations API", () => {
  describe("GET kds/stations", () => {
    it("should handle get request", async () => {
      const request = createMockRequest("GET", "http://localhost:3000/apikds/stations");
  ...
  describe("POST kds/stations", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/apikds/stations");
      // TODO: Import and test actual route handler
