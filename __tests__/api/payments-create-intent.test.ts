/**
 * Auto-generated test for payments/create-intent
 * Generated: 2025-11-23T00:14:32.215Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { POST as postPOST } from "@/app/api/payments/create-intent/route";
...
describe("Payments Create Intent API", () => {
  describe("POST payments/create-intent", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/api//payments/create-intent");
