/**
 * Auto-generated test for reservations/auto-complete
 * Generated: 2025-11-23T00:14:32.217Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest, parseJsonResponse } from "../helpers/api-test-helpers";
import { POST as postPOST } from "@/app/api/reservations/auto-complete/route";
...
describe("Reservations Auto Complete API", () => {
  describe("POST reservations/auto-complete", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/api/reservations/auto-complete");
