...
describe("Auth Health API", () => {
  describe("GET auth/health", () => {
    it("should handle get request", async () => {
      const request = createMockRequest("GET", "http://localhost:3000/apiauth/health");
