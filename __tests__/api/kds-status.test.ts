...
describe("Kds Status API", () => {
  describe("GET kds/status", () => {
    it("should handle get request", async () => {
      const request = createMockRequest("GET", "http://localhost:3000/apikds/status");
