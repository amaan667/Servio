...
import { POST as postPOST } from "@/app/apiadmin/update-tier-to-enterprise/route";
...
describe("Admin Update Tier To Enterprise API", () => {
  describe("POST admin/update-tier-to-enterprise", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/apiadmin/update-tier-to-enterprise");
