/**
 * Auto-generated test for pay/till
 * Generated: 2025-11-23T00:14:32.215Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { POST as postPOST } from "@/app/api/pay/till/route";
...
describe("Pay Till API", () => {
  describe("POST pay/till", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/api//pay/till");
