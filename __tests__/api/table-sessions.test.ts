/**
 * Auto-generated test for table-sessions
 * Generated: 2025-11-23T00:14:32.221Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { POST as postPOST } from "@/app/api/table-sessions/route";
...
describe("Table Sessions API", () => {
  describe("POST table-sessions", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/apitable-sessions");
