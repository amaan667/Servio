/**
 * Auto-generated test for receipts/send-email
 * Generated: 2025-11-23T00:14:32.216Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { POST as postPOST } from "@/app/api/receipts/send-email/route";
...
describe("Receipts Send Email API", () => {
  describe("POST receipts/send-email", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/api//receipts/send-email");
