...
/**
 * Auto-generated test for fix-owner-column
 * Generated: 2025-11-23T00:14:32.210Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { POST as postPOST } from "@/app/api/fix-owner-column/route";
...
describe("Fix Owner Column API", () => {
  describe("POST fix-owner-column", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/apifix-owner-column");
