...
import { POST as postPOST } from "@/app/apistaff/invitations/cancel/route";
...
describe("Staff Invitations Cancel API", () => {
  describe("POST staff/invitations/cancel", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/apistaff/invitations/cancel");
