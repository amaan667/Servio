/**
 * Auto-generated test for staff/invitations/cancel
 * Generated: 2025-11-23T00:14:32.219Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { POST as postPOST } from "@/app/api/staff/invitations/cancel/route";
...
describe("Staff Invitations Cancel API", () => {
  describe("POST staff/invitations/cancel", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/api//staff/invitations/cancel");
