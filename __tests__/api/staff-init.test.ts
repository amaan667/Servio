...
/**
 * Auto-generated test for staff/init
 * Generated: 2025-11-23T00:14:32.218Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { POST as postPOST } from "@/app/api/staff/init/route";
...
describe("Staff Init API", () => {
  describe("POST staff/init", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/api//staff/init");
