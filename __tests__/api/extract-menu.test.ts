/**
 * Auto-generated test for extract-menu
 * Generated: 2025-11-23T00:14:32.209Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { POST as postPOST } from "@/app/api/extract-menu/route";
...
describe("Extract Menu API", () => {
  describe("POST extract-menu", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/apiextract-menu");
