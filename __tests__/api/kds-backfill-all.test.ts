/**
 * Auto-generated test for kds/backfill-all
 * Generated: 2025-11-23T00:14:32.211Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { POST as postPOST } from "@/app/api/kds/backfill-all/route";
...
describe("Kds Backfill All API", () => {
  describe("POST kds/backfill-all", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/api//kds/backfill-all");
