...
import { GET as getGET } from "@/app/apimenu/uploads/[venueId]/category-order/route";
...
describe("Menu Uploads VenueId Category Order API", () => {
  describe("GET menu/uploads/[venueId]/category-order", () => {
    it("should handle get request", async () => {
      const request = createMockRequest("GET", "http://localhost:3000/apimenu/uploads/[venueId]/category-order");
