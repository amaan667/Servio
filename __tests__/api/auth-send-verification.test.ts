...
/**
 * Auto-generated test for auth/send-verification
 * Generated: 2025-11-23T00:14:32.206Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { POST as postPOST } from "@/app/api/auth/send-verification/route";
...
describe("Auth Send Verification API", () => {
  describe("POST auth/send-verification", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/api//auth/send-verification");
