...
import { POST as postPOST } from "@/app/apisubscription/refresh-status/route";
...
describe("Subscription Refresh Status API", () => {
  describe("POST subscription/refresh-status", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/apisubscription/refresh-status");
