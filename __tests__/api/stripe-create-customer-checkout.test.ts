...
import { POST as postPOST } from "@/app/apistripe/create-customer-checkout/route";
...
describe("Stripe Create Customer Checkout API", () => {
  describe("POST stripe/create-customer-checkout", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/apistripe/create-customer-checkout");
