/**
 * Auto-generated test for reservations/by-table/[tableId]
 * Generated: 2025-11-23T00:14:32.217Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { GET as getGET } from "@/app/api/reservations/by-table/[tableId]/route";
...
describe("Reservations By Table TableId API", () => {
  describe("GET reservations/by-table/[tableId]", () => {
    it("should handle get request", async () => {
      const request = createMockRequest("GET", "http://localhost:3000/api//reservations/by-table/[tableId]");
