/**
 * Auto-generated test for admin/update-tier
 * Generated: 2025-11-23T00:14:32.205Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { POST as postPOST } from "@/app/api/admin/update-tier/route";
...
describe("Admin Update Tier API", () => {
  describe("POST admin/update-tier", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/api//admin/update-tier");
