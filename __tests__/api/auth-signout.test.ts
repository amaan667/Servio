...
import { GET as getGET } from "@/app/apiauth/signout/route";
import { POST as postPOST } from "@/app/apiauth/signout/route";
...
describe("Auth Signout API", () => {
  describe("GET auth/signout", () => {
    it("should handle get request", async () => {
      const request = createMockRequest("GET", "http://localhost:3000/apiauth/signout");
  ...
  describe("POST auth/signout", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/apiauth/signout");
      // TODO: Import and test actual route handler
