...
/**
 * Auto-generated test for auth/signout
 * Generated: 2025-11-23T00:14:32.207Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { GET as getGET } from "@/app/api/auth/signout/route";
import { POST as postPOST } from "@/app/api/auth/signout/route";
...
describe("Auth Signout API", () => {
  describe("GET auth/signout", () => {
    it("should handle get request", async () => {
      const request = createMockRequest("GET", "http://localhost:3000/api//auth/signout");
  ...
  describe("POST auth/signout", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/api//auth/signout");
