...
import { GET as getGET } from "@/app/apipos/payments/route";
import { POST as postPOST } from "@/app/apipos/payments/route";
...
describe("Pos Payments API", () => {
  describe("GET pos/payments", () => {
    it("should handle get request", async () => {
      const request = createMockRequest("GET", "http://localhost:3000/apipos/payments");
  ...
  describe("POST pos/payments", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/apipos/payments");
      // TODO: Import and test actual route handler
