/**
 * Auto-generated test for scrape-menu
 * Generated: 2025-11-23T00:14:32.217Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { POST as postPOST } from "@/app/api/scrape-menu/route";
...
describe("Scrape Menu API", () => {
  describe("POST scrape-menu", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/apiscrape-menu");
