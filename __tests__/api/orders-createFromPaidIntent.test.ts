/**
 * Auto-generated test for orders/createFromPaidIntent
 * Generated: 2025-11-23T00:14:32.214Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { POST as postPOST } from "@/app/api/orders/createFromPaidIntent/route";
...
describe("Orders CreateFromPaidIntent API", () => {
  describe("POST orders/createFromPaidIntent", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/api//orders/createFromPaidIntent");
