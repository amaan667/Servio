...
import { POST as postPOST } from "@/app/apiinventory/stock/stocktake/route";
...
describe("Inventory Stock Stocktake API", () => {
  describe("POST inventory/stock/stocktake", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/apiinventory/stock/stocktake");
