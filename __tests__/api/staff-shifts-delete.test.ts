/**
 * Auto-generated test for staff/shifts/delete
 * Generated: 2025-11-23T00:14:32.219Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { POST as postPOST } from "@/app/api/staff/shifts/delete/route";
...
describe("Staff Shifts Delete API", () => {
  describe("POST staff/shifts/delete", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/api//staff/shifts/delete");
