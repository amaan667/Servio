/**
 * Auto-generated test for tables/[tableId]/reissue-qr
 * Generated: 2025-11-23T00:14:32.221Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { POST as postPOST } from "@/app/api/tables/[tableId]/reissue-qr/route";
...
describe("Tables TableId Reissue Qr API", () => {
  describe("POST tables/[tableId]/reissue-qr", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/api//tables/[tableId]/reissue-qr");
