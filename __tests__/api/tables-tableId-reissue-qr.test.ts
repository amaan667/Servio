...
import { POST as postPOST } from "@/app/apitables/[tableId]/reissue-qr/route";
...
describe("Tables TableId Reissue Qr API", () => {
  describe("POST tables/[tableId]/reissue-qr", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/apitables/[tableId]/reissue-qr");
