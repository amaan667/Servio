/**
 * Auto-generated test for menu/update-category
 * Generated: 2025-11-23T00:14:32.212Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { POST as postPOST } from "@/app/api/menu/update-category/route";
...
describe("Menu Update Category API", () => {
  describe("POST menu/update-category", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/api//menu/update-category");
