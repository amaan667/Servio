/**
 * Auto-generated test for feedback/list
 * Generated: 2025-11-23T00:14:32.209Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { POST as postPOST } from "@/app/api/feedback/list/route";
...
describe("Feedback List API", () => {
  describe("POST feedback/list", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/api//feedback/list");
