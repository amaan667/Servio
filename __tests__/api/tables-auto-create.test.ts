...
/**
 * Auto-generated test for tables/auto-create
 * Generated: 2025-11-23T00:14:32.221Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { POST as postPOST } from "@/app/api/tables/auto-create/route";
...
describe("Tables Auto Create API", () => {
  describe("POST tables/auto-create", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/api//tables/auto-create");
