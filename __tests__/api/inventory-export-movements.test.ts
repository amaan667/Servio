...
import { GET as getGET } from "@/app/apiinventory/export/movements/route";
...
describe("Inventory Export Movements API", () => {
  describe("GET inventory/export/movements", () => {
    it("should handle get request", async () => {
      const request = createMockRequest("GET", "http://localhost:3000/apiinventory/export/movements");
