...
import { POST as postPOST } from "@/app/apisubscription/sync-from-stripe/route";
...
describe("Subscription Sync From Stripe API", () => {
  describe("POST subscription/sync-from-stripe", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/apisubscription/sync-from-stripe");
