/**
 * Auto-generated test for live-orders
 * Generated: 2025-11-23T00:14:32.212Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { GET as getGET } from "@/app/api/live-orders/route";
...
describe("Live Orders API", () => {
  describe("GET live-orders", () => {
    it("should handle get request", async () => {
      const request = createMockRequest("GET", "http://localhost:3000/apilive-orders");
