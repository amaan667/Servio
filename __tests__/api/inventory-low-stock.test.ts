/**
 * Auto-generated test for inventory/low-stock
 * Generated: 2025-11-23T00:14:32.210Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { GET as getGET } from "@/app/api/inventory/low-stock/route";
...
describe("Inventory Low Stock API", () => {
  describe("GET inventory/low-stock", () => {
    it("should handle get request", async () => {
      const request = createMockRequest("GET", "http://localhost:3000/api//inventory/low-stock");
