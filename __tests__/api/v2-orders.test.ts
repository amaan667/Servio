...
/**
 * Auto-generated test for v2/orders
 * Generated: 2025-11-23T00:14:32.222Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { GET as getGET } from "@/app/api/v2/orders/route";
...
describe("V2 Orders API", () => {
  describe("GET v2/orders", () => {
    it("should handle get request", async () => {
      const request = createMockRequest("GET", "http://localhost:3000/api/v2/orders");
