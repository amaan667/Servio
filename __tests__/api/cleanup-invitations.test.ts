/**
 * Auto-generated test for cleanup-invitations
 * Generated: 2025-11-23T00:14:32.208Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { POST as postPOST } from "@/app/api/cleanup-invitations/route";
...
describe("Cleanup Invitations API", () => {
  describe("POST cleanup-invitations", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/apicleanup-invitations");
