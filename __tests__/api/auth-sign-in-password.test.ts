...
describe("Auth Sign In Password API", () => {
  describe("POST auth/sign-in-password", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/apiauth/sign-in-password");
