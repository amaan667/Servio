/**
 * Auto-generated test for stripe/webhook
 * Generated: 2025-11-23T00:14:32.220Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { POST as postPOST } from "@/app/api/stripe/webhook/route";
...
describe("Stripe Webhook API", () => {
  describe("POST stripe/webhook", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/api//stripe/webhook");
