/**
 * Auto-generated test for stripe/webhooks
 * Generated: 2025-11-23T00:14:32.220Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { POST as postPOST } from "@/app/api/stripe/webhooks/route";
...
describe("Stripe Webhooks API", () => {
  describe("POST stripe/webhooks", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/api//stripe/webhooks");
