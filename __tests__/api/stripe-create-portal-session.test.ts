...
import { POST as postPOST } from "@/app/apistripe/create-portal-session/route";
...
describe("Stripe Create Portal Session API", () => {
  describe("POST stripe/create-portal-session", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/apistripe/create-portal-session");
