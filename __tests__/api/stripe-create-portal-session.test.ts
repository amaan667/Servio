...
/**
 * Auto-generated test for stripe/create-portal-session
 * Generated: 2025-11-23T00:14:32.219Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { POST as postPOST } from "@/app/api/stripe/create-portal-session/route";
...
describe("Stripe Create Portal Session API", () => {
  describe("POST stripe/create-portal-session", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/api//stripe/create-portal-session");
