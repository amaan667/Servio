/**
 * Auto-generated test for delete-account
 * Generated: 2025-11-23T00:14:32.209Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { POST as postPOST } from "@/app/api/delete-account/route";
...
describe("Delete Account API", () => {
  describe("POST delete-account", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/apidelete-account");
