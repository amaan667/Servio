/**
 * Auto-generated test for feedback/questions/public
 * Generated: 2025-11-23T00:14:32.209Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { GET as getGET } from "@/app/api/feedback/questions/public/route";
...
describe("Feedback Questions Public API", () => {
  describe("GET feedback/questions/public", () => {
    it("should handle get request", async () => {
      const request = createMockRequest("GET", "http://localhost:3000/api//feedback/questions/public");
