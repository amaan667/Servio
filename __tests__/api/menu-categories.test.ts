...
import { GET as getGET } from "@/app/apimenu/categories/route";
import { POST as postPOST } from "@/app/apimenu/categories/route";
import { PUT as putPUT } from "@/app/apimenu/categories/route";
...
describe("Menu Categories API", () => {
  describe("GET menu/categories", () => {
    it("should handle get request", async () => {
      const request = createMockRequest("GET", "http://localhost:3000/apimenu/categories");
  ...
  describe("POST menu/categories", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/apimenu/categories");
      // TODO: Import and test actual route handler
  ...
  describe("PUT menu/categories", () => {
    it("should handle put request", async () => {
      const request = createMockRequest("PUT", "http://localhost:3000/apimenu/categories");
      // TODO: Import and test actual route handler
