...
import { GET as getGET } from "@/app/api/menu/categories/route";
import { POST as postPOST } from "@/app/api/menu/categories/route";
import { PUT as putPUT } from "@/app/api/menu/categories/route";
...
describe("Menu Categories API", () => {
  describe("GET menu/categories", () => {
    it("should handle get request", async () => {
      const request = createMockRequest("GET", "http://localhost:3000/api//menu/categories");
  ...
  describe("POST menu/categories", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/api//menu/categories");
      // TODO: Import and test actual route handler
  ...
  describe("PUT menu/categories", () => {
    it("should handle put request", async () => {
      const request = createMockRequest("PUT", "http://localhost:3000/api//menu/categories");
      // TODO: Import and test actual route handler
