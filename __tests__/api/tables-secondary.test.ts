...
/**
 * Auto-generated test for tables/secondary
 * Generated: 2025-11-23T00:14:32.222Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { GET as getGET } from "@/app/api/tables/secondary/route";
...
describe("Tables Secondary API", () => {
  describe("GET tables/secondary", () => {
    it("should handle get request", async () => {
      const request = createMockRequest("GET", "http://localhost:3000/api//tables/secondary");
