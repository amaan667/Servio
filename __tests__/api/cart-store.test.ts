...
import { GET as getGET } from "@/app/apicart/store/route";
import { POST as postPOST } from "@/app/apicart/store/route";
...
describe("Cart Store API", () => {
  describe("GET cart/store", () => {
    it("should handle get request", async () => {
      const request = createMockRequest("GET", "http://localhost:3000/apicart/store");
  ...
  describe("POST cart/store", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/apicart/store");
      // TODO: Import and test actual route handler
