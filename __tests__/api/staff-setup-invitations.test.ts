...
/**
 * Auto-generated test for staff/setup-invitations
 * Generated: 2025-11-23T00:14:32.219Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { POST as postPOST } from "@/app/api/staff/setup-invitations/route";
...
describe("Staff Setup Invitations API", () => {
  describe("POST staff/setup-invitations", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/api//staff/setup-invitations");
