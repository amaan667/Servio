/**
 * Auto-generated test for reviews/list
 * Generated: 2025-11-23T00:14:32.217Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { GET as getGET } from "@/app/api/reviews/list/route";
...
describe("Reviews List API", () => {
  describe("GET reviews/list", () => {
    it("should handle get request", async () => {
      const request = createMockRequest("GET", "http://localhost:3000/api//reviews/list");
