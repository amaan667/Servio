/**
 * Auto-generated test for tables/clear
 * Generated: 2025-11-23T00:14:32.221Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { POST as postPOST } from "@/app/api/tables/clear/route";
...
describe("Tables Clear API", () => {
  describe("POST tables/clear", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/api//tables/clear");
