/**
 * Auto-generated test for ai/job-status
 * Generated: 2025-11-23T00:14:32.206Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { GET as getGET } from "@/app/api/ai/job-status/route";
...
describe("Ai Job Status API", () => {
  describe("GET ai/job-status", () => {
    it("should handle get request", async () => {
      const request = createMockRequest("GET", "http://localhost:3000/api//ai/job-status");
