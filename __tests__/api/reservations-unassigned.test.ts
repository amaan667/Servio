/**
 * Auto-generated test for reservations/unassigned
 * Generated: 2025-11-23T00:14:32.217Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { GET as getGET } from "@/app/api/reservations/unassigned/route";
...
describe("Reservations Unassigned API", () => {
  describe("GET reservations/unassigned", () => {
    it("should handle get request", async () => {
      const request = createMockRequest("GET", "http://localhost:3000/api//reservations/unassigned");
