/**
 * Auto-generated test for tables/cleanup-duplicates
 * Generated: 2025-11-23T00:14:32.221Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { POST as postPOST } from "@/app/api/tables/cleanup-duplicates/route";
...
describe("Tables Cleanup Duplicates API", () => {
  describe("POST tables/cleanup-duplicates", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/api//tables/cleanup-duplicates");
