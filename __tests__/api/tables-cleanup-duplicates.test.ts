...
import { POST as postPOST } from "@/app/apitables/cleanup-duplicates/route";
...
describe("Tables Cleanup Duplicates API", () => {
  describe("POST tables/cleanup-duplicates", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/apitables/cleanup-duplicates");
