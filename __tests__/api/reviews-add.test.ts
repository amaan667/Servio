...
/**
 * Auto-generated test for reviews/add
 * Generated: 2025-11-23T00:14:32.217Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { POST as postPOST } from "@/app/api/reviews/add/route";
...
describe("Reviews Add API", () => {
  describe("POST reviews/add", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/api//reviews/add");
