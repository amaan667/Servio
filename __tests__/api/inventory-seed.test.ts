/**
 * Auto-generated test for inventory/seed
 * Generated: 2025-11-23T00:14:32.211Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { POST as postPOST } from "@/app/api/inventory/seed/route";
...
describe("Inventory Seed API", () => {
  describe("POST inventory/seed", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/api//inventory/seed");
