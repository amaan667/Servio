...
import { POST as postPOST } from "@/app/apistripe/create-checkout-session/route";
...
describe("Stripe Create Checkout Session API", () => {
  describe("POST stripe/create-checkout-session", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/apistripe/create-checkout-session");
