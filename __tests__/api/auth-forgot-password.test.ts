...
/**
 * Auto-generated test for auth/forgot-password
 * Generated: 2025-11-23T00:14:32.206Z
 */

import { describe, it, expect, vi } from "vitest";
import { createMockRequest } from "../helpers/api-test-helpers";
import { POST as postPOST } from "@/app/api/auth/forgot-password/route";
...
describe("Auth Forgot Password API", () => {
  describe("POST auth/forgot-password", () => {
    it("should handle post request", async () => {
      const request = createMockRequest("POST", "http://localhost:3000/api//auth/forgot-password");
