-- Fix Table Creation 503 Error
-- This script removes the problematic constraint that's preventing table creation
...
SELECT 'Table creation constraint fix completed successfully!' as message;
