-- =====================================================
-- TABLE MANAGEMENT REFACTOR - AFTER STATUS COLUMN EXISTS
-- =====================================================
-- This script assumes the status column already exists in table_sessions
-- Run this AFTER running add-status-column-only.sql
...
-- =====================================================
-- 2. ADD SERVER_ID COLUMN TO TABLE_SESSIONS
-- =====================================================
...
-- First, update existing data to map to new values BEFORE creating enum
...
-- =====================================================
-- 9. CREATE TABLE ACTIONS API FUNCTIONS
-- =====================================================
...
-- =====================================================
-- 11. ENSURE FREE SESSIONS FOR ALL ACTIVE TABLES
-- =====================================================
