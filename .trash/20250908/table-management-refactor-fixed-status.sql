-- =====================================================
-- TABLE MANAGEMENT REFACTOR - FIXED STATUS COLUMN VERSION
-- =====================================================
-- This script ensures the status column is created FIRST before any references
...
-- =====================================================
-- 2. CRITICAL: ADD STATUS COLUMN FIRST
-- =====================================================
...
BEGIN
  ...
  RAISE NOTICE 'Added missing columns safely';
