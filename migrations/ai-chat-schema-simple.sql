-- AI Assistant Chat System Schema - Simple Version
-- Avoids type casting issues by using text columns for user IDs

-- Chat conversations table
CREATE TABLE IF NOT EXISTS ai_chat_conversations (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  venue_id UUID NOT NULL,
  user_id TEXT NOT NULL, -- Changed to TEXT to match auth.uid()
...
CREATE TABLE IF NOT EXISTS ai_undo_actions (
  ...
  executed_by TEXT NOT NULL -- Changed to TEXT to match auth.uid()
);
...
-- Create policies for ai_chat_conversations (no type casting needed)
...
-- Create policies for ai_chat_messages (no type casting needed)
...
-- Create policies for ai_undo_actions (no type casting needed)
...
-- Create policies for ai_context_cache (with UUID casting for venue_id)
...
-- Create policies for ai_action_audit (no type casting needed)
