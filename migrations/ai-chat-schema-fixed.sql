-- AI Assistant Chat System Schema - Fixed Version
-- Handles type casting issues between text and UUID
...
-- Create policies for ai_chat_conversations (with proper type casting)
...
-- Create policies for ai_chat_messages (with proper type casting)
...
-- Create policies for ai_undo_actions (with proper type casting)
...
-- Create policies for ai_context_cache (with proper type casting)
...
-- Create policies for ai_action_audit (with proper type casting)
