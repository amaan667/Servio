 ...
 */
export function extractColorsFromText(text: string): { primary: string; secondary: string; accent: string } {
  // Default colors
  ...
  const colorKeywords = {
    primary: ['red', 'crimson', 'burgundy', 'maroon', 'purple', 'violet', 'blue', 'navy', 'black', 'dark'],
