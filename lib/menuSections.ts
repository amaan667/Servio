...
const HEADINGS = [
  ...
  "BEVERAGES","WEEKLY SPECIALS","DRINKS","APPETIZERS","ENTREES",
  "MAINS","MAIN DISHES","SPECIALS","COMBINATIONS","GRILLS",
  "PASTA","PIZZA","BURGERS","SANDWICHES","WRAPS","BOWLS",
  "PLATTERS","SHARING","KIDS","CHILDREN","LUNCH","DINNER",
  "BREAKFAST","BRUNCH","ALL DAY BRUNCH","AFTERNOON TEA","COFFEE","TEA","JUICES",
  "SMOOTHIES","MILKSHAKES","ALCOHOL","WINE","BEER","COCKTAILS",
  "SPIRITS","LIQUEURS","SHAKES","FLOATS","HOT DRINKS","COLD DRINKS"
];
