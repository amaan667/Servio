-- Fix the merge function overload issue by dropping old functions and creating a single properly typed version
-- This resolves the PGRST203 error about function overloading
...
-- Create a single, properly typed function that accepts TEXT parameters
-- (UUIDs can be passed as TEXT strings)
