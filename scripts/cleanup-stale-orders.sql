...
-- Handle table_number based sessions by joining with tables table
UPDATE table_sessions 
SET 
    status = 'FREE',
    order_id = NULL,
...
-- Also handle by table label for table_number based orders
UPDATE table_runtime_state 
SET 
    primary_status = 'FREE',
    order_id = NULL,
...
-- ========================================
-- OPTIONAL: MORE AGGRESSIVE CLEANUP (uncomment if needed)
-- ========================================

-- Uncomment these lines if you want to close ALL active orders (not just stale ones)
-- WARNING: This will close ALL active orders, including recent ones!

/*
-- Close ALL active orders (use with caution!)
UPDATE orders 
SET 
    order_status = 'COMPLETED',
    updated_at = NOW()
