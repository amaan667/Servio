...
async function main() {
  ...
  switch (command) {
    case 'api-route':
      generator.writeFile(`app/api/${generator.toKebabCase(name)}/route.ts`, generator.generateAPIRoute(name));
      break;

    case 'component':
      generator.writeFile(`components/${generator.toKebabCase(name)}.tsx`, generator.generateComponent(name));
      break;

    case 'server-component':
      generator.writeFile(`components/${generator.toKebabCase(name)}.tsx`, generator.generateComponent(name, true));
      break;

    case 'client-component':
      generator.writeFile(`components/${generator.toKebabCase(name)}.tsx`, generator.generateComponent(name, false));
      break;

    case 'service':
      generator.writeFile(`lib/services/${generator.toKebabCase(name)}-service.ts`, generator.generateService(name));
      break;

    case 'hook':
      generator.writeFile(`hooks/use${generator.toPascalCase(name)}.ts`, generator.generateHook(name));
      break;

    case 'test-api':
      generator.writeFile(`__tests__/api/${generator.toKebabCase(name)}.test.ts`, generator.generateTest(name, 'api'));
      break;

    case 'test-component':
      generator.writeFile(`__tests__/components/${generator.toKebabCase(name)}.test.tsx`, generator.generateTest(name, 'component'));
      break;

    case 'test-service':
      generator.writeFile(`__tests__/services/${generator.toKebabCase(name)}-service.test.ts`, generator.generateTest(name, 'service'));
      break;
