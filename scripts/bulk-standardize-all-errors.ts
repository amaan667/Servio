/**
 * Bulk standardize ALL error responses to use apiErrors
 * This script will replace NextResponse.json({ error: ... }) patterns
 */
...
function standardizeFile(filePath: string): boolean {
  ...
  // Replace 400 errors - simple pattern
  content = content.replace(
  ...
  // Replace 500 errors - more complex pattern
  content = content.replace(
