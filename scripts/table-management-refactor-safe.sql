-- =====================================================
-- TABLE MANAGEMENT REFACTOR - SAFE VERSION
-- =====================================================
-- This script safely handles missing columns and applies the refactor
...
-- Create index on status column (now that it exists)
