        ...
        <TooltipTrigger asChild>
          ...
          >
            ...
            <span className="absolute -top-1 -right-1 flex h-5 w-5">
              ...
              <span className="relative inline-flex rounded-full h-5 w-5 bg-purple-500 items-center justify-center text-[10px] font-bold">
                AI
              </span>
            </span>
          </button>
        ...
        <TooltipContent side="left" className="bg-purple-600 text-white border-purple-700">
          <div className="flex flex-col items-center gap-1">
            ...
            <span className="text-xs opacity-90">
              Press <kbd className="px-1.5 py-0.5 bg-purple-700 rounded text-white font-mono">{shortcutKey}</kbd>
            </span>
          </div>
        </TooltipContent>
      </Tooltip>
