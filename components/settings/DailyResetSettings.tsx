...
export function DailyResetSettings({ 
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const timeWithSeconds = resetTime.includes(':') && resetTime.split(':').length === 2 
        ? `${resetTime}:00` 
        : resetTime;
      ...
      logError('Error updating reset time:', err);
      ...
      <CardContent className="space-y-6">
        ...
        <div className="text-xs text-gray-500 space-y-1">
          ...
          <ul className="list-disc list-inside space-y-1 ml-2">
            ...
            <li><strong>04:00 (4 AM)</strong> - Late night venues that close after midnight</li>
            <li><strong>06:00 (6 AM)</strong> - Early morning venues</li>
          </ul>
          <p className="mt-2">
