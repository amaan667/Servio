    ...
    return (
      <nav aria-label="Breadcrumb" className="mb-4">
        <ol className="flex items-center gap-2 text-sm">
          <li>
            <Button asChild variant="ghost" size="sm" className="flex items-center gap-1 text-gray-800 hover:text-gray-900 font-medium">
              <Link href={homeLink}>
                <>
          ...
          <li className="text-gray-800 font-medium">Demo</li>
        </ol>
      </nav>
    );
  }
