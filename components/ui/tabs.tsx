...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      "inline-flex items-center justify-center whitespace-nowrap rounded-md px-3 sm:px-4 py-2 sm:py-1.5 text-sm sm:text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:text-purple-600 data-[state=active]:bg-white data-[state=active]:shadow-[0_0_12px_rgba(147,51,234,0.4)] data-[state=active]:border-purple-200 data-[state=active]:hover:bg-purple-600 data-[state=active]:hover:text-white data-[state=inactive]:bg-white data-[state=inactive]:text-purple-600 data-[state=inactive]:border-2 data-[state=inactive]:border-purple-600 flex-1 min-h-[44px] sm:min-h-0 border-2 border-transparent",
      className
    )}
    {...props}
  />
