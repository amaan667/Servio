          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-purple-100 mb-8 leading-relaxed">
                Streamline your business operations with contactless QR code ordering. Customers scan, order, and pay -
                all from their phones. You focus on great food and service.
              </p>
            ...
            <div className="relative">
              <div className="bg-white rounded-2xl shadow-2xl p-8 transform rotate-3 hover:rotate-0 transition-transform duration-300">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 mb-4">Scan to view menu & order</p>
      ...
      <section id="features" className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Everything You Need to Modernize Your Business</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              From QR code generation to real-time order management, Servio provides all the tools you need to create a
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600">
                  Generate unique QR codes for each table. Customers scan to instantly access your menu and start
                  ordering.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600">
                  Beautiful, responsive interface optimized for mobile devices. Your customers will love the smooth
                  ordering experience.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-8">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-4">Real-Time Orders</h3>
                <p className="text-gray-600">
                  Receive orders instantly in your dashboard. Track order status and manage your kitchen workflow
                  efficiently.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-8">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-4">Payment Integration</h3>
                <p className="text-gray-600">
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600">
                  Detailed analytics on sales, popular items, and customer behavior to help you make data-driven
                  decisions.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-8">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-4">Staff Management</h3>
                <p className="text-gray-600">
                  Manage your team with role-based access. Kitchen staff, servers, and managers each get the tools they
                  need.
                </p>
              </CardContent>
            </Card>
      ...
      <section id="testimonials" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">See what business owners are saying about Servio</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="border-0 shadow-lg">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600 mb-6">
                  "Servio transformed our cafe completely. Orders are faster, more accurate, and our customers love the
                  convenience. Revenue is up 30%!"
                </p>
                <div className="flex items-center">
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600 mb-6">
                  "The setup was incredibly easy. Within an hour, we had QR codes on all our tables. The real-time order
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600 mb-6">
                  "Our staff can focus on food quality instead of taking orders. Customer satisfaction has improved
                  dramatically since we started using Servio."
                </p>
                <div className="flex items-center">
      ...
      <section className="py-24 bg-gradient-to-r from-purple-600 to-purple-700 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-purple-100 mb-8">
            Join thousands of businesses already using Servio to streamline their operations and delight their
            customers.
          </p>
