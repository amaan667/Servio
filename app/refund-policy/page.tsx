        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 mb-4 text-gray-700">
              ...
              <li>Contact us at <a href="mailto:support@servio.app" className="text-purple-600 hover:underline">support@servio.app</a></li>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              To claim a service failure refund, contact <a href="mailto:support@servio.app" className="text-purple-600 hover:underline">support@servio.app</a> with:
            </p>
            <ul className="list-disc pl-6 mb-4 text-gray-700">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              When you cancel, you retain access until the end of your paid period. See our <Link href="/terms" className="text-purple-600 hover:underline">Terms of Service</Link> for details.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              <p className="text-gray-700"><strong>Email:</strong> <a href="mailto:support@servio.app" className="text-purple-600 hover:underline">support@servio.app</a></p>
              <p className="text-gray-700 mt-2"><strong>Billing:</strong> <a href="mailto:billing@servio.app" className="text-purple-600 hover:underline">billing@servio.app</a></p>
              <p className="text-gray-700 mt-2"><strong>General:</strong> <a href="mailto:hello@servio.app" className="text-purple-600 hover:underline">hello@servio.app</a></p>
            </div>
          </section>
        </div>
      </div>
