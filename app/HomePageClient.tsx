                ...
                >
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <Button
                      ...
                      variant="servio"
                      className="w-full group hover:text-servio-purple disabled:bg-gray-400 disabled:hover:bg-gray-400 disabled:cursor-not-allowed disabled:text-white transition-all duration-200 shadow-sm hover:shadow-md active:scale-95"
                      size="lg"
