      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          ...
          <p className="text-sm text-gray-600 mb-4">
            These are the variables accessible in the browser. They must have the NEXT_PUBLIC_ prefix.
          </p>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
          ...
          <ul className="space-y-2 text-sm">
            <li className="flex items-start">
              ...
              <span>If both show values (not "MISSING"), your Railway environment variables are configured correctly.</span>
            </li>
            <li className="flex items-start">
              <span className="text-red-600 mr-2">❌</span>
              <span>If they show "MISSING", you need to add these variables in Railway dashboard.</span>
            </li>
          </ul>
        </div>
