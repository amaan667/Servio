    ...
    const getSession = async () => {
      ...
      if (session?.user) {
        ...
        if (venues && venues.length > 0) {
          ...
          setVenue(userVenue);
          await loadMenuItems(userVenue.venue_id);
        } else {
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-muted-foreground">Loading menu builder...</p>
        </div>
      </div>
    );
  }
        ...
        {activeTab === 'manage' && (
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent>
                <MenuUploadCard venueId={venueId} onSuccess={() => loadMenuItems(venueId)} />
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              {showCategories && (
                <CardContent>
                  <CategoriesManagement venueId={venueId} onCategoriesUpdate={() => loadMenuItems(venueId)} />
                </CardContent>
              )}
            </Card>
