    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <Alert variant="destructive">
          ...
          <AlertDescription>Please sign in to generate QR codes.</AlertDescription>
        </Alert>
      </div>
    )
  }
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Create a unique QR code for each table at <strong>{session.venue.name}</strong>. Customers will scan this
              to access your menu and place orders.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-6">
              ...
              <div className="bg-white border-2 border-gray-200 rounded-lg p-8 flex justify-center">
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-600 font-medium">Table {tableNumber}</p>
                  <p className="text-xs text-gray-500">Scan to view menu & order</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <Button variant="outline" onClick={handleTestQR} disabled={!qrCodeUrl}>
              ...
              <Alert>
                <AlertTriangle className="h-4 w-4" />
                <AlertDescription>
                  <strong>Pro Tip:</strong> Print the QR code and place it on each table. Make sure it's clearly visible
                  and easy to scan. You can also laminate it for durability.
                </AlertDescription>
              </Alert>
            </div>
          </CardContent>
