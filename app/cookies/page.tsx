...
export const metadata: Metadata = {
  title: "Cookie Policy",
  description: "Understand how Servio uses cookies and similar technologies. Learn about essential, functional, and analytics cookies on our platform.",
  openGraph: {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">These cookies are necessary for the Service to function:</p>
            <ul className="list-disc pl-6 mb-4 text-gray-700">
              ...
              <li><strong>Security cookies</strong> - Protect against fraud and attacks</li>
            ...
            <ul className="list-disc pl-6 mb-4 text-gray-700">
              ...
              <li><strong>Recent venues</strong> - Quick access to your venues</li>
              <li><strong>Display preferences</strong> - UI customization</li>
            </ul>
            ...
            <ul className="list-disc pl-6 mb-4 text-gray-700">
              ...
              <li><strong>Improvement insights</strong> - Help us enhance features</li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full border border-gray-300 mb-4">
                ...
                <tbody>
                  <tr>
                    <td className="border border-gray-300 px-4 py-2 text-gray-700">sb-*-auth-token</td>
                    <td className="border border-gray-300 px-4 py-2 text-gray-700">Authentication & session</td>
                  ...
                  <tr>
                    ...
                    <td className="border border-gray-300 px-4 py-2 text-gray-700">Remember dark/light mode</td>
                  ...
                  <tr>
                    <td className="border border-gray-300 px-4 py-2 text-gray-700">servio-session</td>
                    <td className="border border-gray-300 px-4 py-2 text-gray-700">Session management</td>
                    <td className="border border-gray-300 px-4 py-2 text-gray-700">Essential</td>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              ...
              See <a href="https://stripe.com/privacy" target="_blank" rel="noopener noreferrer" className="text-purple-600 hover:underline">Stripe's Privacy Policy</a>.
            </p>

            <h3 className="text-xl font-semibold mb-3 mt-6">4.2 Supabase (Infrastructure)</h3>
            <p className="text-gray-700 mb-4">
              Our database provider uses cookies for authentication and session management.
              See <a href="https://supabase.com/privacy" target="_blank" rel="noopener noreferrer" className="text-purple-600 hover:underline">Supabase's Privacy Policy</a>.
            </p>

            <h3 className="text-xl font-semibold mb-3 mt-6">4.3 Google Cloud (AI Features)</h3>
            <p className="text-gray-700 mb-4">
              Google Cloud services process menu uploads and AI requests.
              See <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" className="text-purple-600 hover:underline">Google's Privacy Policy</a>.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              <p className="text-gray-700"><strong>Email:</strong> <a href="mailto:privacy@servio.app" className="text-purple-600 hover:underline">privacy@servio.app</a></p>
              <p className="text-gray-700 mt-2"><strong>Website:</strong> <a href="https://servio.app" className="text-purple-600 hover:underline">servio.app</a></p>
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 mb-4 text-gray-700">
              <li><a href="https://www.allaboutcookies.org" target="_blank" rel="noopener noreferrer" className="text-purple-600 hover:underline">AllAboutCookies.org</a></li>
              <li><a href="https://ico.org.uk/for-the-public/online/cookies/" target="_blank" rel="noopener noreferrer" className="text-purple-600 hover:underline">UK ICO Cookie Guidance</a></li>
            </ul>
          </section>
        </div>
      </div>
