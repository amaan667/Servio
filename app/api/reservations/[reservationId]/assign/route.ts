...
export async function POST(
  ...
  try {
    ...
    if (error) {
      logger.error('[RESERVATIONS ASSIGN] Error:', { error: error instanceof Error ? error.message : 'Unknown error' });
    ...
    logger.error('[RESERVATIONS ASSIGN] Unexpected error:', { error: error instanceof Error ? getErrorMessage(error) : 'Unknown error' });
