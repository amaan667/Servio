...
export async function POST(
  ...
  try {
    ...
    if (error) {
      logger.error('[TABLES CLOSE] Error:', { error: error instanceof Error ? error.message : 'Unknown error' });
    ...
    logger.error('[TABLES CLOSE] Unexpected error:', { error: error instanceof Error ? getErrorMessage(error) : 'Unknown error' });
