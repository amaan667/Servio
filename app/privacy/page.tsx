        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 mb-4 text-gray-700">
              ...
              <li><strong>Communication:</strong> Send service updates, security alerts, and marketing communications (with your consent)</li>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 mb-4 text-gray-700">
              <li><strong>Service Providers:</strong> Stripe (payments), Supabase (database), Google Cloud (infrastructure), OpenAI (AI features)</li>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 mb-4 text-gray-700">
              ...
              <li><strong>Order Data:</strong> For 7 years (UK tax compliance requirements)</li>
              <li><strong>Analytics Data:</strong> For 2 years</li>
              <li><strong>Backup Data:</strong> For 30 days after deletion</li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              To exercise these rights, contact us at: <a href="mailto:privacy@servio.app" className="text-purple-600 hover:underline">privacy@servio.app</a>
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              For more details, see our <Link href="/cookies" className="text-purple-600 hover:underline">Cookie Policy</Link>.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              Servio is not intended for children under 16. We do not knowingly collect personal information from children. 
          ...
          <section className="mb-8">
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              <p className="text-gray-700"><strong>Website:</strong> <a href="https://ico.org.uk" target="_blank" rel="noopener noreferrer" className="text-purple-600 hover:underline">ico.org.uk</a></p>
              <p className="text-gray-700 mt-2"><strong>Phone:</strong> 0303 123 1113</p>
              <p className="text-gray-700 mt-2"><strong>Address:</strong> Information Commissioner's Office, Wycliffe House, Water Lane, Wilmslow, Cheshire, SK9 5AF</p>
            </div>
          </section>
        </div>
      </div>
