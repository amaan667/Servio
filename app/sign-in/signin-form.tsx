  ...
  return (
    <div className="w-full bg-white rounded-lg shadow-md p-4 sm:p-6 lg:p-8">
      ...
      <Button
        ...
        className="w-full bg-white border border-gray-300 text-black hover:bg-gray-50 flex items-center justify-center gap-2 mb-4 sm:mb-6 h-10 sm:h-11 font-medium"
      >
        ...
        <span className="text-sm sm:text-base font-medium text-black">{isLoading ? 'Signing in...' : 'Sign in with Google'}</span>
      </Button>
