  ...
  return (
    <div className="w-full bg-white rounded-lg shadow-md p-4 sm:p-6 lg:p-8">
      <div className="text-center mb-6 sm:mb-8">
        ...
        <p className="text-sm sm:text-base text-gray-600">Sign in to manage your venue</p>
      </div>
      ...
      <Button
        ...
        className="w-full bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 flex items-center justify-center gap-2 mb-4 sm:mb-6 h-10 sm:h-11"
      >
