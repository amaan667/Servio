    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <Card className="w-full max-w-md">
        ...
        <CardContent className="space-y-4">
          ...
          {/* Simple Test Button for Desktop Debugging */}
          {process.env.NODE_ENV === 'development' && (
            <Button
              onClick={() => {
                console.log('[DESKTOP DEBUG] Test button clicked');
                console.log('[DESKTOP DEBUG] Button click handler works');
                alert('Button click handler is working! Check console for details.');
              }}
              variant="outline"
              className="w-full text-xs bg-green-50 border-green-200 text-green-800"
            >
              🧪 Test Button Click (Desktop Debug)
            </Button>
          )}
