...
export function OrderTabs({ activeTab, onTabChange, counts }: OrderTabsProps) {
  const tabs = [
    { key: 'live', label: 'Live', longLabel: 'Live Orders', hint: 'Recent orders', count: counts.live },
    { key: 'all', label: 'Earlier', longLabel: 'Earlier Today', hint: "Today's orders", count: counts.earlier },
    { key: 'history', label: 'History', longLabel: 'History', hint: 'Previous days', count: counts.history },
  ];
