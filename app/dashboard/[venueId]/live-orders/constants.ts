...
export const LIVE_WINDOW_STATUSES = ['PLACED', 'IN_PREP', 'READY', 'SERVING', 'SERVED', 'COMPLETED'];
export const ACTIVE_TABLE_ORDER_STATUSES = ['PLACED', 'IN_PREP', 'READY', 'SERVING', 'SERVED'];
export const LIVE_TABLE_ORDER_STATUSES = ['PLACED', 'IN_PREP', 'READY', 'SERVING', 'SERVED', 'COMPLETED'];
