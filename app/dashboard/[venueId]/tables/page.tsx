...
const TableManagementClientNew = dynamicImport(
  () =>
    import("./table-management-client-new").then((mod) => ({
      default: mod.TableManagementClientNew,
    })),
  {
    loading: () => (
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-24 md:pb-8">
        ...
        />
        <Suspense
          fallback={<div className="text-center py-8 text-gray-900">Loading tables...</div>}
        >
