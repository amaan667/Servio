...
export default function MenuClientPage({ venueId }: { venueId: string }) {
    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-24 md:pb-8">
        ...
        <div className="mb-8 mt-4">
          ...
          <p className="text-lg text-foreground mt-2">View your menu</p>
        </div>

        <MenuClient venueId={venueId} venueName={venueName || "Your Venue"} />
      </div>
    </div>
  );
}
