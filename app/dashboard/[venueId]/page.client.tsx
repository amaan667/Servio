    ...
    <PullToRefresh onRefresh={handleRefresh}>
      <div className="min-h-screen bg-background">
        ...
        <div className="mb-6 sm:mb-8">
          ...
          <p className="text-gray-700 dark:text-gray-300 text-sm sm:text-base font-medium">Here's what's happening at {venue?.name || "your venue"} today</p>
        </div>
            ...
            <Card className="cursor-pointer hover:shadow-lg transition-shadow">
              <CardContent className="p-4 sm:p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300">Today's Orders</p>
          ...
          <Link href={`/dashboard/${venueId}/analytics`}>
            <Card className="cursor-pointer hover:shadow-lg transition-shadow">
              <CardContent className="p-4 sm:p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300">Revenue</p>
           ...
           <Link href={`/dashboard/${venueId}/tables`}>
            <Card className="cursor-pointer hover:shadow-lg transition-shadow">
              <CardContent className="p-4 sm:p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300">Tables Set Up</p>
          ...
          <Link href={`/dashboard/${venueId}/menu`}>
            <Card className="cursor-pointer hover:shadow-lg transition-shadow">
              <CardContent className="p-4 sm:p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300">Menu Items</p>
          ...
          <Link href={`/dashboard/${venueId}/live-orders`}>
            <Card className="hover:shadow-lg transition-shadow cursor-pointer">
              <CardContent className="p-4 sm:p-6">
                ...
                <p className="text-gray-700 dark:text-gray-300 text-xs sm:text-sm font-medium">Monitor and manage incoming orders in real-time</p>
              </CardContent>
            </Card>
          </Link>
          ...
          <Link href={`/dashboard/${venueId}/menu`}>
            <Card className="hover:shadow-lg transition-shadow cursor-pointer">
              <CardContent className="p-4 sm:p-6">
                ...
                <p className="text-gray-700 dark:text-gray-300 text-xs sm:text-sm font-medium">Update your menu items and manage categories</p>
              </CardContent>
            </Card>
          </Link>
          ...
          <Link href={`/generate-qr?venue=${venueId}`}>
            <Card className="hover:shadow-lg transition-shadow cursor-pointer">
              <CardContent className="p-4 sm:p-6">
                ...
                <p className="text-gray-700 dark:text-gray-300 text-xs sm:text-sm font-medium">Generate and manage QR codes for your tables</p>
              </CardContent>
            </Card>
          </Link>
            ...
            >
              <Card className="hover:shadow-lg transition-shadow cursor-pointer">
                <CardContent className="p-4 sm:p-6">
                  ...
                  <p className="text-gray-700 dark:text-gray-300 text-xs sm:text-sm font-medium">Monitor table status and manage service flow</p>
                </CardContent>
              </Card>
            </Link>
          )}
          ...
          <Link href={`/dashboard/${venueId}/analytics`}>
            <Card className="hover:shadow-lg transition-shadow cursor-pointer">
              <CardContent className="p-4 sm:p-6">
                ...
                <p className="text-gray-700 dark:text-gray-300 text-xs sm:text-sm font-medium">View detailed reports and business insights</p>
              </CardContent>
            </Card>
          </Link>
          ...
          <Link href={`/dashboard/${venueId}/feedback`}>
            <Card className="hover:shadow-lg transition-shadow cursor-pointer">
              <CardContent className="p-4 sm:p-6">
                ...
                <p className="text-gray-700 dark:text-gray-300 text-xs sm:text-sm font-medium">See customer reviews and ratings</p>
              </CardContent>
            </Card>
          </Link>
          ...
          <Link href={`/dashboard/${venueId}/staff`}>
            <Card className="hover:shadow-lg transition-shadow cursor-pointer">
              <CardContent className="p-4 sm:p-6">
                ...
                <p className="text-gray-700 dark:text-gray-300 text-xs sm:text-sm font-medium">Add staff and manage roles</p>
              </CardContent>
            </Card>
          </Link>
        ...
        <div className="mt-12">
          <Card>
            <CardHeader>
              ...
              <p className="text-gray-700 dark:text-gray-300 font-medium">Complete these steps to set up your venue</p>
            </CardHeader>
              ...
              <div className="flex items-center justify-between p-4 bg-muted rounded-lg">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-700 dark:text-gray-300 font-medium">Upload your menu or add items manually</p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between p-4 bg-muted rounded-lg">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-700 dark:text-gray-300 font-medium">Create QR codes for your tables</p>
                  </div>
                </div>
                <Button variant="outline" asChild>
              ...
              <div className="flex items-center justify-between p-4 bg-muted rounded-lg">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-700 dark:text-gray-300 font-medium">Customize your venue settings</p>
                  </div>
                </div>
                <Button variant="outline" asChild>
