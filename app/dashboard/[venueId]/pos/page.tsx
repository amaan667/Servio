...
export default async function POSPage({ params }: { params: Promise<{ venueId: string }> }) {
  ...
  const canAccessPOS =
    ...
    finalUserRole === "server" ||
    finalUserRole === "cashier";
    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-24 md:pb-8">
        ...
        <div className="mb-8 mt-4">
          ...
          <p className="text-lg text-foreground mt-2">Manage tables, orders, and payments</p>
        </div>
        ...
        {canAccessPOS ? (
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
            ...
            <p className="text-yellow-700">
              You don&apos;t have permission to access the Point of Sale system. This feature is
              available for Owner, Manager, Server, and Cashier roles only.
            </p>
          </div>
        )}
      </div>
