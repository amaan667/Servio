      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-24 md:pb-8">
        ...
        <div className="mb-8 mt-4">
          ...
          <p className="text-lg text-foreground mt-2">
            {canEditInventory ? 'Track ingredients, manage stock levels, and control costs' : 'View inventory levels'}
          </p>
          {!canEditInventory && (
            <div className="mt-4 bg-blue-50 border border-blue-200 rounded-lg p-4">
              <p className="text-sm text-blue-800">
                <strong>Read-only mode:</strong> You can view inventory but cannot make changes. Only Owners and Managers can edit inventory.
              </p>
            </div>
          )}
        </div>
        
        <InventoryClient venueId={venueId} venueName={finalVenue?.venue_name || "Your Venue"} canEdit={canEditInventory} />
      </div>
    </div>
  );
}
